...
LOCKED_PARENT_CHILD_OPTION_SEEDS = {
    AA_NA_PARENT_ACTIVITY_KEY: AA_NA_MEETING_OPTION_SEEDS,
    VOLUNTEER_PARENT_ACTIVITY_KEY: VOLUNTEER_COMMUNITY_SERVICE_OPTION_SEEDS,
    MEDICAL_HEALTH_PARENT_ACTIVITY_KEY: MEDICAL_HEALTH_OPTION_SEEDS,
    LEGAL_PARENT_ACTIVITY_KEY: LEGAL_OPTION_SEEDS,
    PROGRAM_PARENT_ACTIVITY_KEY: PROGRAM_OPTION_SEEDS,
    JOB_SEARCH_PARENT_ACTIVITY_KEY: JOB_SEARCH_OPTION_SEEDS,
    SOCIAL_SERVICES_PARENT_ACTIVITY_KEY: SOCIAL_SERVICES_OPTION_SEEDS,
    EDUCATION_PARENT_ACTIVITY_KEY: EDUCATION_OPTION_SEEDS,
}
...
def _child_option_seeds_for_parent(parent_activity_key: str) -> list[str]:
    return list(LOCKED_PARENT_CHILD_OPTION_SEEDS.get(parent_activity_key, []))
...
def load_kiosk_activity_categories_for_shelter(shelter: str) -> list[dict]:
    ...
    # Always leave room to add more rows in admin.
    blank_rows_needed = 8 if not categories else 4
...
def load_kiosk_activity_child_options_for_shelter(
    ...
    # Always leave room to add more child options in admin.
    blank_rows_needed = 8 if not options else 4
    for _ in range(blank_rows_needed):
        options.append(
            {
                "id": "",
