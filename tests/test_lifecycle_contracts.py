...
def test_lifecycle_resident_transfer_helper_moves_open_passes_only(app):
    ...
    with app.app_context():
        ...
        pending_pass_id = _insert_pass(resident_id=resident_id, shelter="abba", status="pending")
        approved_pass_id = _insert_pass(resident_id=resident_id, shelter="abba", status="approved")
        denied_pass_id = _insert_pass(resident_id=resident_id, shelter="abba", status="denied")
        completed_pass_id = _insert_pass(resident_id=resident_id, shelter="abba", status="completed")
        ...
        assert pass_rows[approved_pass_id]["shelter"] == "haven"
