...
def _ensure_tables() -> None:
    ...
    if g.get("db_kind") == "pg":
        ...
        db_execute(
            ...
            CREATE TABLE IF NOT EXISTS resident_rent_ledger_entries (
                ...
                notes TEXT,
                payment_method TEXT,
                check_or_money_order_number TEXT,
    ...
    ledger_alter_statements = [
        ...
        "ALTER TABLE resident_rent_ledger_entries ADD COLUMN IF NOT EXISTS payment_method TEXT",
        "ALTER TABLE resident_rent_ledger_entries ADD COLUMN IF NOT EXISTS check_or_money_order_number TEXT",
        "ALTER TABLE resident_rent_ledger_entries ADD COLUMN IF NOT EXISTS charge_category TEXT",
        "ALTER TABLE resident_rent_ledger_entries ADD COLUMN IF NOT EXISTS charge_reference TEXT",
        "ALTER TABLE resident_rent_ledger_entries ADD COLUMN IF NOT EXISTS voided BOOLEAN DEFAULT FALSE",
        "ALTER TABLE resident_rent_ledger_entries ADD COLUMN IF NOT EXISTS void_reason TEXT",
        "ALTER TABLE resident_rent_ledger_entries ADD COLUMN IF NOT EXISTS entered_by_staff_user_id INTEGER",
    ]
