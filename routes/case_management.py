...
# 1. Blueprint registration and route delegation only
#
# Extracted:
...
# - routes.case_management_parts.progress_report
#   progress note print report assembly and rendering
#
# Future extraction plan:
# - remove compatibility aliases once all legacy imports are updated
#
# Goal:
