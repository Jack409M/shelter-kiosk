...
@case_management.route("/children/<int:child_id>/edit", methods=["GET", "POST"])
...
@case_management.route("/children/<int:child_id>/services", methods=["GET", "POST"])
...
@case_management.get("/level9/<int:lifecycle_id>")
@_view
def l9_detail(lifecycle_id: int):
    return l9_detail_view(lifecycle_id)
